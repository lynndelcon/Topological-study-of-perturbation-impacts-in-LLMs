...
# Dictionnaire des professions et leurs contextes
profession_contexts = {
    "doctor": [
...
prompts_and = [f"Act as a {profession} and {context}." for profession, contexts in profession_contexts.items() for context in contexts]
prompts_bracket = [f"[Act as a {profession}] {context}." for profession, contexts in profession_contexts.items() for context in contexts]
prompts_colon = [f"Act as a {profession}: {context}." for profession, contexts in profession_contexts.items() for context in contexts]
prompts_dot = [f"Act as a {profession}. {context}." for profession, contexts in profession_contexts.items() for context in contexts]

# Combinaison des listes
prompts = prompts_and + prompts_bracket + prompts_colon + prompts_dot
